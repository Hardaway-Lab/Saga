...
def plot_rs_data(plot_dict: dict, title_keyword: str):
    ...
    if constants.OUTPUT_PLOTS:
        plt.savefig(f"{constants.OUTPUT_PLOTS_DIR}/rs_charts_{title_keyword.lower()}.png")
...
def plot_corrected(corrected_dict: dict, pellets: list, title_keyword="Corrected"):
    ...
    if constants.OUTPUT_PLOTS:
        plt.savefig(f"{constants.OUTPUT_PLOTS_DIR}/{title_keyword.lower()}_charts.png")
...
def plot_fit(df_dict, corrected_dict, fit_dict):
    ...
    if constants.OUTPUT_PLOTS:
        plt.savefig(f"{constants.OUTPUT_PLOTS_DIR}/plot_fit_green.png")
    ...
    if constants.OUTPUT_PLOTS:
        plt.savefig(f"{constants.OUTPUT_PLOTS_DIR}/plot_fit_red.png")
...
def plot_normalized(all_trials_dict, error_dict):
    ...
    if constants.OUTPUT_PLOTS:
        plt.savefig(f"{constants.OUTPUT_PLOTS_DIR}/SP 7-7_38pellet_Refeed.png")
